...
# Create a summary table based on all responses
responses_folder_path = f"{args.query_output_path}/final_comparison"

# Initialize a dictionary to store counts
criteria_counts = {}

# Define the fixed list of possible winners
possible_winners = ["Answer 1", "Answer 2", "Answer 3", "Unknown"]

# Define the fixed list of criteria
...
for filename in os.listdir(responses_folder_path):
    if filename.endswith(".json"):
        ...
        with open(file_path, "r", encoding="utf-8-sig") as file:
            ...
            cleaned_content = content.replace('"```json', "").replace('```"', "").replace("\\n", "").replace('\\','').strip()  # Ensuring any extra whitespace is removed
...
# Save to CSV
output_csv_path = os.path.join(responses_folder_path, "summary.csv")
