...
async def main():
    ...
    async def comparison_agent(question, answer1, answer2, answer3 , mistral):
        ...
        messages.append({"role": "system", "content": """
                        You are an expert tasked with evaluating two answers to the same question based on the following criteria.
                         ---Goal---
                        You will evaluate two answers to the same question based on the following criteria.
    ...
    for filename in file_list:
        ...
        with open(filename, 'r', encoding='utf-8-sig') as file:
            ...
            response = await query_without_rag(f"{file_contents}", args.mistral)
        ...
        with open(f"{args.query_output_path}/with_multiagent_rag/response_{os.path.basename(filename)}", 'r', encoding='utf-8-sig') as file:
            # Read the contents of the file
            answer3 = file.read()
        result = await comparison_agent(question, answer1, answer2, answer3 , args.mistral)
        try:
        ...
        ragonly_result = await comparison_agent(question, "None", answer2, answer3 , args.mistral)
        try:
