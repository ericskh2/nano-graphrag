...
# local agents folder
from retrieval_strategy_agent_mistral import RetrievalStrategyAgent
from generation_agent_mistral import GenerationAgent
from feedback_agent_mistral import FeedbackAgent
from refinement_agent_mistral import RefinementAgent
from scoring_agent_mistral import ScoringAgent
...
def run_orchestrator_agent_alt(work_directory_path: str, query_input_path: str, query_output_path: str, score_threshold: float = 4, iteration_threshold: int = 3) -> OrchestratorAgentResponse:
    """
...
if __name__ == "__main__":
    ...
    if args.alternate:
        run_orchestrator_agent_alt(work_directory_path=work_directory_path, query_input_path=query_input_path, query_output_path=query_output_path, score_threshold=100, iteration_threshold=3)
    else:
